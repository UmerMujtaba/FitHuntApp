...
const BrblStdOvrHdPrsVid = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={container}>
      <ScrollView>
        ...
        <View style={Vid}>
          <VideoPlayer
            video={require('../../assets/videos/shldr/BrblStdOvrHdPrsVid.mp4')}
            autoplay={false}
            defaultMuted={true}
            videoWidth={1200}
            videoHeight={900}
        ...
        <View style={ins}>
          <Text style={txt}>
            ...
            the barbell at the line of your collar bone, with your elbow
...
export default BrblStdOvrHdPrsVid;
