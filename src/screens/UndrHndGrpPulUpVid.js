...
const UndrHndGrpPulUpVid = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={container}>
      <ScrollView>
        ...
        <View style={Vid}>
          <VideoPlayer
            video={require('../../assets/videos/back/lats/UndrHndGrpPulUpVid.mp4')}
            autoplay={false}
            defaultMuted={true}
            videoWidth={1200}
            videoHeight={900}
        ...
        <View style={ins}>
          <Text style={txt}>
            Grip the bar with an underhand grip at shoulder width, with elbows
...
export default UndrHndGrpPulUpVid;
