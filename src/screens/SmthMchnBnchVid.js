...
const SmthMchnBnchVid = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={container}>
      ...
      <View style={Vid}>
        <VideoPlayer
          video={require('../../assets/videos/chest/smithbnchprs.mp4')}
          autoplay={false}
          defaultMuted={true}
          videoWidth={1200}
          videoHeight={900}
      ...
      <View style={ins}>
        ...
        Lower the bar with control until contact is made with the lower chest, then extend your elbows until they are locked.
...
export default SmthMchnBnchVid;
