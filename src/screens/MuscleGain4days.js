        ...
        <View style={mid}>
          ...
          <View style={info2}>
            <View style={info}>
              <View style={imgg}>
                <Image
                  source={require('../../assets/block/4days/mg/dumbellbreanchpress.png')}
                />
              </View>
              <View style={txt5}>
            ...
            <View style={info}>
              <View style={imgg}>
                <Image
                  source={require('../../assets/block/4days/mg/inclinedubbellcurl.png')}
                />
              </View>
              <View style={txt5}>
            ...
            <View style={info}>
              <View style={imgg}>
                <Image
                  source={require('../../assets/block/4days/mg/Machinesupportdpullups,overhandgrips.png')}
                />
              </View>
              <View style={txt5}>
            ...
            <View style={info}>
              <View style={imgg}>
                <Image
                  source={require('../../assets/block/4days/mg/DumbellOverheadTricepExtesion.png')}
                />
              </View>
              <View style={txt5}>
            ...
            <View style={info}>
              <View style={imgg}>
                <Image
                  source={require('../../assets/block/4days/mg/SelectorOverheadPressMachine,Wide.png')}
                />
              </View>
              <View style={txt5}>
