...
const MuscleGain4days = ({navigation}) => {
  const {
    container,
    mid,
    nav,
        ...
        <View style={mid}>
          ...
          <View style={info}>
            ...
            <View style={insideInfo}>
              ...
              <Text style={txt4}>26</Text>
            </View>
            <View style={insideInfo}>
              <Text style={txt3}>Duration</Text>
              <Text style={txt4}>60-70 min</Text>
            </View>
          </View>
          <View style={info2}>
            <View style={info}>
              <View style={imgg}>
                <Image source={require('../../assets/block/4days/mg/dumbellbreanchpress.png')}/>
              </View>
              <View style={txt5}>
            ...
            <View style={info}>
              <View style={imgg}>
              <Image source={require('../../assets/block/4days/mg/inclinedubbellcurl.png')}/>
              </View>
              <View style={txt5}>
                <Text style={txt6}>Incline Dumbebll Curl</Text>
                <Text style={txt7}>3 sets * 10-12 reps</Text>
              </View>
              <View style={muscle}>
                <TouchableOpacity style={btn4}>
            ...
            <View style={info}>
              <View style={imgg}>
              <Image source={require('../../assets/block/4days/mg/Machinesupportdpullups,overhandgrips.png')}/>
              </View>
              <View style={txt5}>
                <Text style={txt6}>Machine Supported Pullps</Text>
                <Text style={txt7}>3 sets * 10-12 reps</Text>
              </View>
              <View style={muscle}>
                <TouchableOpacity style={btn4}>
            ...
            <View style={info}>
              <View style={imgg}>
              <Image source={require('../../assets/block/4days/mg/DumbellOverheadTricepExtesion.png')}/>
              </View>
              <View style={txt5}>
            ...
            <View style={info}>
              <View style={imgg}>
              <Image source={require('../../assets/block/4days/mg/SelectorOverheadPressMachine,Wide.png')}/>
              </View>
              <View style={txt5}>
                <Text style={txt6}>Overhead Machine Press</Text>
                <Text style={txt7}>3 sets * 10-12 reps</Text>
              </View>
              <View style={muscle}>
                <TouchableOpacity style={btn5}>
...
export default MuscleGain4days;
