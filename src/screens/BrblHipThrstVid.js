...
const BrblHipThrstVid = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={container}>
      <ScrollView>
        ...
        <View style={Vid}>
          <VideoPlayer
            video={require('../../assets/videos/back/glute/BrblHipThrst.mp4')}
            autoplay={false}
            defaultMuted={true}
            videoWidth={1200}
            videoHeight={900}
        ...
        <View style={ins}>
          <Text style={txt}>
            ...
            barbell on your hips. Extend and raise your hips as far up as
...
export default BrblHipThrstVid;
